...
public class SongParserTest {
	...
	public void testNormalLine() {
		...
		Assertions.assertThat(result).isEqualTo("<div class=\"line\"><div class=\"chords\"><div is=\"chord\" name=\"Am\"></div></div>This is <div class=\"chords\"><div is=\"chord\" name=\"Em\"></div></div>the text <div class=\"chords\"><div is=\"chord\" name=\"A\"></div></div>line</div></div>");
	}

	@Test
	public void testEmptyChordLine() {
		Text body = new Text();
		body.addLine("% ");
		body.addLine("> This is the text line");
		...
		Assertions.assertThat(result).isEqualTo("<div class=\"line\">This is the text line</div></div>");
	}

	@Test
	public void testTwoTextLines() {
		Text body = new Text();
		body.addLine("> First line with lyrics");
		body.addLine("> Second line with lyrics");

		String result = songParser.parseBody(body.toString(), allSongChords);

		Assertions.assertThat(result).isEqualTo("<div class=\"line\">First line with lyrics</div><div class=\"line\">Second line with lyrics</div></div>");
	}
